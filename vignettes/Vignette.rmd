...
plot1 <- boxplot_trio(syn_polar,
                      ...
                      step_increase = 0.1) +
  labs(title="Adjusted Pvalues bewteen SLAMF6 Expression")
...
plot2 <- boxplot_trio(syn_polar,
                      ...
                      levels_order = c("Lymphoid", "Myeloid", "Fibroid"),
                      box_colours = c("blue", "red", "green3")) +
  labs(title="Significance bewteen SLAMF6 Expression")
...
plot3 <- boxplot_trio(syn_polar,
  ...
  labs(title="T-test Pvalues bewteen PARP16 Expression")
...
plot4 <- boxplot_trio(syn_polar,
                      ...
                      box_colours = c("blue", "red", "green3"),
                      step_increase = 0.1) +
  labs(title="Wilcox Pvalues bewteen ITM2C Expression")
