...
mytable = data.frame(
  ...
  pvals = c("pvals\ 
              ...
              "the pvals matrix which contains the statistical\
                significance of probes or variables between classes. This contains: \
...
expressed genes between 3 classes using 2 pipeline functions to allow statistical
...
It is also possible to spin/rotate the plot (adding a 4th dimension) using the
volcano4D function which adds a modeBar button:
