...
data set. 
To explore more extensive examples and view the interactive radial and volcano plots, see the [extended vignette](https://katrionagoldmann.github.io/volcano3D/articles/Extended_Vignette.html) 
...
using radial_plotly. Unfortunately CRAN does not support interactive plotly 
images in the vignette, but these can be viewed on the [extended vignette](https://katrionagoldmann.github.io/volcano3D/articles/Extended_Vignette.html).

```{r, eval=FALSE, fig.height=5}
radial_plotly(polar = syn_polar, label_rows = c("SLAMF6", "GREM2", "FMOD")) 
```

<img src="./radial_plotly.png" align="center" alt="" width="700" style="border: 0;"/>

When interactive, it is possible to identify genes for
...
support WebGL in the vignette so we only include a static image in this document. 
However the fully interactive plots can be viewed on the [extended vignette](https://katrionagoldmann.github.io/volcano3D/articles/Extended_Vignette.html).
...
<img src="./volcano3D.png" align="center" alt="" width="500" style="border: 0;"/>

Again this produces an interactive plot but since WebGL is not supported in
vignette html we have only included a static image. To see this in action you can visit the [extended vignette](https://katrionagoldmann.github.io/volcano3D/articles/Extended_Vignette.html)
. If you have
