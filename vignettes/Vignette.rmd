...
plot3 <- boxplot_trio(syn_polar,
  ...
  labs(title="T-tests bewteen FMOD Exp.")
...
For further settings and aesthetics see the  [extended vignette](https://katrionagoldmann.github.io/volcano3D/articles/Extended_Vignette.html)
