...
This creates an polar class object with slots for: sampledata, contrast, pvalues, multi_group_test, expression, polar and non_sig_name. The pvalues slot which should have a data frame with at least two 
statistics for each comparison - pvalue and adjusted pvalue - and an optional 
