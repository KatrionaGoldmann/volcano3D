...
syn_pvalues$Fibroid_Lymphoid_pvalue = factor(syn_pvalues$Fibroid_Lymphoid_pvalue)
...
We can alter the colours using the colours parameter. These are assigned in 
