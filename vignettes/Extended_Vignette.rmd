...
| <b>volc3d</b> | A polar coordinates object, of S4 class, containing the expression data, sample outcome data, pvalues and polar coordinates. |
...
First we will set up a 'volc3d' object, using the polar_coords function, which
uses:
