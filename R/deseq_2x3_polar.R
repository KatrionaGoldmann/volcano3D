...
#' RNA-Seq count data. It takes 3 `DESeqDataSet` objects each with the same
...
#'
#' @param object A list of 3 objects of class 'DESeqDataSet', or a list of 3
#'   DESeq2 results dataframes generated by calling `DESeq2::results()`. Each
